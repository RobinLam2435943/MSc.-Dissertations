...
Copula transformations and inverse copula transformations are set.
...
The prior distributions are sketched as follows.
...
```{r, fig.cap = "Pair Plots for Parameters of the L'Aquila Sequence"}
etas$envir$pairplot
```
