...
synth.model <- function(syn = mult.synth, 
    ...
    samp.id <- hier_clu_samp(syn, kmax)[slice]
...
mult.synth.fit <- lapply(seq_len(4), \(i) synth.model(syn = mult.synth,
...
ecdf_interarrival <- lapply(seq_len(4), \(j) ECDF.interarrival(j))
```
