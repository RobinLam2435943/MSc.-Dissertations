...
synth.fit <- function(breaks = c(0, 125, 150, 200, 400, 1600),
    ...
    Npost[[5]]$post.df$Catalogues <- 'Random Catalogue 5: 400 to 1600 Events'
...
```{r}
# # plot them
# ggplot(mult.synth.fit$environ$bind.post.N.df,
#                       aes(x = N, y = mean, color = 
#                         Catalogues)) +
#    geom_line() +
#    xlab("N") +
#    ylab("pdf") +
#    geom_vline(
#      data = mult.synth.fit$environ$df.true.N,
#      mapping = aes(xintercept = N), linetype = 2
#    )
```
