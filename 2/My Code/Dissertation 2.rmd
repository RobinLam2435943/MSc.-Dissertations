...
mult.synth.fit <- rep(list(NULL), 4)
mult.synth.fit[[1]] <- synth.fit(breaks =
                                     c(0, 110, 130, 150, 170, 190, 210))
# mult.synth.fit[[2]] <- synth.fit(breaks =
#                                      c(210, 240, 270, 300, 330, 360, 400))
# mult.synth.fit[[3]] <- synth.fit(breaks = c(400, 600, 800, 1600))
# 
# mult.synth.fit[[4]] <- synth.fit(breaks = c(0, 400, 800, 1600), 
#                                  samp.each.class = 2, syn = mult.synth.imp) 
```
...
ecdf_interarrival <- lapply(seq_len(1), \(j) ECDF.interarrival(j))
```
